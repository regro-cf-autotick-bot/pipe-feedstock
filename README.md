...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pipe-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14804&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pipe-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pipe` can be installed with:

```
conda install pipe
```

It is possible to list all of the versions of `pipe` available on your platform with:
